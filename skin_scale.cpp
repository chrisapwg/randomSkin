...
static const MString _commandName = "scaleSkin";
...
MSyntax scaleSkin::commandSyntax() {
    MSyntax syntax;
...
scaleSkin::scaleSkin() : // Set default value, similar like python def(args, args, args):
    MPxCommand(),
    _mIsUndoable(true),
    _mValue(0.2),
    _mInfluence(8),
...
bool scaleSkin::isUndoable() const {
    return (_mIsUndoable);
}

void* scaleSkin::creator() {
    return (new scaleSkin());
}

MString scaleSkin::commandName() {
    return (_commandName);
}
...
MStatus scaleSkin::doIt(const MArgList& args) {
    // ============================================== //
    // ============================================== //
    // ============================================== //
