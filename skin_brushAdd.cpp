...
static const MString _commandName = "brushAdd";
...
MSyntax brushAdd::commandSyntax() {
    MSyntax syntax;
...
brushAdd::brushAdd() : // Set default value, similar like python def(args, args, args):
    MPxCommand(),
    _mIsUndoable(true),
    _mValue(0.2),
    _mInfluence(8),
...
bool brushAdd::isUndoable() const {
    return (_mIsUndoable);
}

void* brushAdd::creator() {
    return (new brushAdd());
}

MString brushAdd::commandName() {
    return (_commandName);
}
...
MStatus brushAdd::doIt(const MArgList& args) {
    // ============================================== //
    // ============================================== //
    // ============================================== //
