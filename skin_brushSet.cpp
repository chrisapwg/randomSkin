...
static const MString _commandName = "brushSet";
...
MSyntax brushSet::commandSyntax() {
    MSyntax syntax;
...
brushSet::brushSet() : // Set default value, similar like python def(args, args, args):
    MPxCommand(),
    _mIsUndoable(true),
    _mValue(0.2),
    _mInfluence(8),
...
bool brushSet::isUndoable() const {
    return (_mIsUndoable);
}

void* brushSet::creator() {
    return (new brushSet());
}

MString brushSet::commandName() {
    return (_commandName);
}
...
MStatus brushSet::doIt(const MArgList& args) {
    // ============================================== //
    // ============================================== //
    // ============================================== //
