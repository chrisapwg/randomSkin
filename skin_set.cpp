...
static const MString _commandName = "setSkin";
...
setSkin::setSkin() : // Set default value, similar like python def(args, args, args):
    MPxCommand(),
    _mIsUndoable(true),
    _mValue(0.2),
    _mInfluence(8),
...
bool setSkin::isUndoable() const {
    return (_mIsUndoable);
}

void* setSkin::creator() {
    return (new setSkin());
}

MString setSkin::commandName() {
    return (_commandName);
}
...
MStatus setSkin::doIt(const MArgList& args) {
    // ============================================== //
    // ============================================== //
    // ============================================== //
