...
static const MString _commandName = "exportSkin";
static const char* _flagPrune[2] = { "-p", "-prune" };

MSyntax exportSkin::commandSyntax() {
	MSyntax syntax;
...
exportSkin::exportSkin() : // Set default value, similar like python def(args, args, args):
	MPxCommand(),
	_mIsUndoable(true),
	_mPrune(0.0001)
{
...
bool exportSkin::isUndoable() const {
	return (_mIsUndoable);
}

void* exportSkin::creator() {
	return (new exportSkin());
}

MString exportSkin::commandName() {
	return (_commandName);
}
...
MStatus exportSkin::doIt(const MArgList& args) {
	// ============================================== //
	// ============================================== //
	// ============================================== //
	...
	setResult(_mDouble_weightData_allSelected);

	return (redoIt());
}

MStatus exportSkin::redoIt() {
	return (MS::kSuccess);
}
